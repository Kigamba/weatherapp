...
/**
 * Sigleton class responsible of loading resources.
 */
public class Resources {

    // List of cities to be used in test mode
    ...
    final public void updateMode(int mode) {
        ...
        background = loadImage("bg_" + modeSuffix + ".png");
    }
    ...
    public Image getAddIcon() {
        if (addIcon == null) {
            addIcon = loadImage("add_icon.png");
        }
        return addIcon;
    }
